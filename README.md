...
MIMS Final Project - ML tool for OpenMRS

//this is the html entry form
...
<h2>Enter encounter information (required)</h2>
			...
			<table class="who-when-where">
				<tr>
					<td>Observation</td>
					<td>
						<obs  conceptId="6542" style = "autocomplete" commentFieldLabel="Clinal Note" rows="5" cols="60"/>
<br/>
					</td>
				</tr>
	...
	{	
	     ...
	     console.log(x);
	        ...
	        $j("#dialog-message").html("These are your recommendations."+x[0]+","+x[2]);
